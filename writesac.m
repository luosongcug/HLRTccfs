...
% Song Luo, 2022/11/13, I found a bug in C(3) = {''}; I revise it by C(3) = {' '};
% Song Luo, 2022/11/29, I comment "%         if size(C,1) ~= 8
%             error([' Number of characters in some of K-header-variabl', ...
%                 'es in file ', s(f).FILENAME,' are larger than 8 !!!']);
%         end"
% otherwise it will lead to errors when station name has a length larger
% than 8 char. 
